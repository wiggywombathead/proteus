...
\begin{appendices}
    ...
    % Actual timetable
    \includepdf[landscape=true,pages=1,pagecommand={\section{Actual
    Timetable}, \label{app:actual_timetable}}]{timetable/timetable.pdf}
    \includepdf[landscape=true,pages=2,pagecommand={}]{timetable/timetable.pdf}

    % Revised Timetable
    \includepdf[landscape=true,pages=1,pagecommand={\section{Progress Report -
    Timetable}, \label{app:timetable}}]{../progress_report/timetable/timetable.pdf}
    \includepdf[landscape=true,pages=2,pagecommand={}]{../progress_report/timetable/timetable.pdf}
