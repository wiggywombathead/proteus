...
\subsection{System Overview}
    ...
    set up, and an interface similar to the C standard library's \code{malloc()}
    and \code{free()} is implemented to manage this.
...
\subsection{Project management}
    ...
    \subsubsection{Organisation}
        ...
        Progress was initially considered in the project specification (see
        Appendix B), for which a preliminary schedule was devised. After two
        months of development, this was then revised in the progress report.  A
        copy of this version is provided in Appendix \ref{app:timetable}, and an
        evaluation of how effective and accurate these timetables were is
        discussed in Section \ref{sec:evaluation}. In order to monitor progress,
        regular meetings were held with the project supervisor, Adam Chester,
        during which recent achievements and current issues were discussed, with
        guidance given in the case of the latter.
